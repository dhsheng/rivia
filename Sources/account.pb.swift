...
extension LoginWithOAuthRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LoginWithOAuthRequest"
  ...
  static func ==(lhs: LoginWithOAuthRequest, rhs: LoginWithOAuthRequest) -> Bool {
...
extension LoginWithEmailRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LoginWithEmailRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "email"),
  ...
  static func ==(lhs: LoginWithEmailRequest, rhs: LoginWithEmailRequest) -> Bool {
    if lhs.email != rhs.email {return false}
